...
This module provides on-device object detection capabilities by using the yolov11.
"""
...
class Yolov11(retico_core.AbstractModule):
    @staticmethod
    def name():
        return "Yolov11 Object Detection Module"
    
    @staticmethod
    def description():
        return "An object detection module using YOLOv11."
